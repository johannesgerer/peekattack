...
Generated: May 19th 2010 1:47:24 AM PDT
Machine: 10.27.27.115
Location: JIT Construction: v247688
Locale: en_US
 */
...
if (!window.FB)
	FB = {
		...
		_domain : {
			...
			staticfb : (window.location.protocol == 'https:' ? 'https://s-static.ak.facbook.com/'
				...
				'UIServer',
				{
					...
					popup : function(a) {
						var g = typeof window.screenX != 'undefined' ? window.screenX
								...
								: document.body.clientWidth, e = typeof window.outerHeight != 'undefined' ? window.outerHeight
								: (document.body.clientHeight - 22), j = a.size.width, c = a.size.height, d = parseInt(
...
FB.subclass('XFBML.EdgeWidget', 'XFBML.IframeWidget', null, {
	...
	_getWidgetWidth : function() {
		...
		var b = d[c][e];
		var f = this._getPxAttribute('width', b);
		var a = {
			bar : {
				min : 600,
				max : 900
